...
class AbbyTraining(Measurement):
    ...
    def run(self):
        ...
        self.waterR = DAQSimpleDOTask('Dev1/port0/line{}'.format(self.waterline))
        self.waterR.low()
    ...
    def run_trial_type(self, types):
        ...
        if types == 0:
            ...
            self.determine_reward_lickUnlimited(self.duration_odor_to_action, check_action=False)
